...
\label{fig:modell}
\centering
\includegraphics[width=0.4\linewidth]{modell_dining_philosophers.png}
\end{figure}
...
\label{problem}
Um das Problem ausfindig zu machen, gibt es verschiedene Möglichkeiten eine Verklemmung grafisch darzustellen. Das Problem lässt sich besser auflösen, wenn es sichtbar gemacht werden kann.
