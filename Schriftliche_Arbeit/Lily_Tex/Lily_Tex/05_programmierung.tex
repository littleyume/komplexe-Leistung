        ...
        while True:
            ...
            try:
                ...
                if locked:
                    ...
                    print("{} hat die linke Gabel freigegeben"
                    .format(current_process().name))
                    #wenn Zustand = locked ist(die Philosophen 
                    #gegessen haben), wird erst der Lock "rightFork" 
                    #und dann Lock "leftFork" freigegeben
                else:
                    self.leftFork.release() 
                    #wenn Zustand != locked, dann Lock "leftFork" frei 
                    #geben(weil "rightFork" nicht frei war)
                    print("{} hat die linke Gabel freigegeben"
                    .format(current_process().name))  
