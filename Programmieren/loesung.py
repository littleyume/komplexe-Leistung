...
class Philosophers(Process):
    ...
    def run(self):
        ...
        while True:
            ...
            print("{} ist fertig mit denken".format(current_process().name)) #Philosoph x ist bereit zum Essen
            ...
            try:
                ...
                if locked:
                    ...
                    print("{} hat die rechte Gabel freigegeben".format(current_process().name)) #Philosoph ist fertg mit essen und gibt
